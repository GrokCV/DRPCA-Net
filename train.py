...
class Trainer(object):
    def __init__(self, args):
        ...
        if args.dataset == 'sirstaug':
            ...
            trainset = SirstDataset(base_dir=r'/opt/data/private/xzh/RPCANet-main/datasets/SIRSTdevkit-master', mode='train', base_size=args.base_size)
            valset = SirstDataset(base_dir=r'/opt/data/private/xzh/RPCANet-main/datasets/SIRSTdevkit-master', mode='test', base_size=args.base_size)
        else:
